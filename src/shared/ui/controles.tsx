...
export const BotaoPrimario = forwardRef<HTMLButtonElement, BotaoProps>(
  function BotaoPrimario({ className, children, carregando, disabled, ...rest }, ref) {
    return (
      <button
        ref={ref}
        ...
        {...rest}
      >
        {carregando && <CircleNotch weight="bold" className="size-4 animate-spin" aria-hidden />}
        {children}
      </button>
    )
  }
...
export const BotaoFantasma = forwardRef<HTMLButtonElement, BotaoProps>(
  function BotaoFantasma({ className, children, carregando, disabled, ...rest }, ref) {
    return (
      <button
        ref={ref}
        disabled={carregando || disabled}
