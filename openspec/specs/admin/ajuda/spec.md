# admin/ajuda Specification

## Purpose
Botão flutuante de ajuda com um FAQ em texto, disponível em todo o painel administrativo, para reduzir a dependência de suporte direto nas dúvidas mais comuns de uso.
