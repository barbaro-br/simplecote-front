...
- [x] 2.3 Verificar visualmente (dev server, redimensionar a janela cruzando 768px) que a barra alterna corretamente entre os dois modos, inclusive em tempo real sem precisar recarregar.
