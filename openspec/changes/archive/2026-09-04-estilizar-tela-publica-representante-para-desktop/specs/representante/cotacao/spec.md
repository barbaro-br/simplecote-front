...
#### Scenario: Código de barras fica numa linha própria, abaixo da quantidade

- **WHEN** o representante visualiza um item que tem código de barras
- **THEN** o código de barras aparece numa linha própria logo abaixo da linha de unidade/embalagem/quantidade, nunca ao lado do nome do produto
