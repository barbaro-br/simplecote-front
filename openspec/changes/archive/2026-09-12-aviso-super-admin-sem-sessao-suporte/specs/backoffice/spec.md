...
#### Scenario: SUPER_ADMIN sem sessão de suporte na aba é avisado

- **WHEN** uma sessão `SUPER_ADMIN` chega numa rota `/admin/**` sem um token de suporte válido para esta aba
- **THEN** o sistema mostra um aviso explicando que a sessão de suporte não foi encontrada nesta aba antes de redirecionar pro backoffice
