...
- **THEN** vê o novo logo SVG no cabeçalho e o hero preenchendo a tela inteira (nada da próxima seção espiando por baixo), com o vídeo de marca de fundo e os CTAs "Criar conta" e "Entrar" legíveis; ao rolar, o vídeo permanece fixo e as seções (Como funciona, Por que, Planos, Comece grátis) passam por cima como painéis translúcidos, com snap suave entre elas
